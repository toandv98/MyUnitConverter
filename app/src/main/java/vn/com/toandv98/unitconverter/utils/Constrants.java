...
public final class Constrants {
    ...
    public static final int TEMPERATURE = 100006;
    public static final int CURRENCY = 100012;

    static final int CELSIUS = 900;
    static final int FAHRENHEIT = 901;
    static final int KELVIN = 902;
    static final int RANKINE = 903;
    static final int DELISLE = 904;
    static final int NEWTON = 905;
    static final int REAUMUR = 906;
    static final int ROMER = 907;
    static final int GAS_MARK = 908;
}