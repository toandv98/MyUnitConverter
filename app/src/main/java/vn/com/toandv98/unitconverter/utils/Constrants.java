...
public final class Constrants {
    ...
    public static final String API_URL = "http://data.fixer.io/api/";
    ...
    public static final int BEL = 1300;
    public static final int DECIBEL = 1301;
    public static final int NEPER = 1302;

    public static final int TERA = 1308;
    public static final int GIGA = 1309;
    public static final int MEGA = 1310;
    public static final int KILO = 1311;
    public static final int HECTO = 1312;
    public static final int DEKA = 1313;
    public static final int DECI = 1314;
    public static final int CENTI = 1315;
    public static final int MILLI = 1316;
    public static final int MICRO = 1317;
    public static final int NANO = 1318;
    public static final int PICO = 1319;
    //endregion
}